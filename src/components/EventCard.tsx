...
const Card = ({ src, alt, name, date, description }: Props) => {
  return (
    <div className="max-w-2xl w-full xl:w-[400px] rounded overflow-hidden shadow-lg flex flex-col mb-24">
      {/* <div className="relative flex h-96 items-start overflow-hidden rounded-lg">
        <Image src={src} alt={alt} style={{ width: "100%", height: "auto" }} />
      </div> */}
      <div className="w-full h-[350px] border-2 border-white overflow-y-hidden mt-6 pt-12 xl:pt-0">
